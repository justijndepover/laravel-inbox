...
var render = function() {
  ...
  return _c("header", { staticClass: "bg-gray-800 flex p-3 items-center" }, [
    _c("div", { staticClass: "pr-3 hidden lg:block" }, [
      _c(
        "a",
        {
          staticClass:
    ...
    _vm._v(" "),
    _c("div", { staticClass: "pr-3 block lg:hidden" }, [
      _c(
        "div",
        { staticClass: "cursor-pointer", on: { click: _vm.openMenu } },
        [
          _c("div", {
            staticClass: "w-6 mb-1 bg-gray-600 rounded",
          ...
          _vm._v(" "),
          _c("div", {
            staticClass: "w-6 bg-gray-600 rounded",
            staticStyle: { height: "2px" }
          })
        ]
      )
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "h-full w-full max-w-xs bg-gray-200 border-r overflow-scroll z-20 fixed inset-y-0 lg:relative transform transition-all duration-300 lg:translate-x-0",
      class: _vm.sidemenuIsOpen ? "translate-x-0" : "-translate-x-full"
    },
    [
      _c(
        "button",
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "div",
            { staticClass: "flex-1 flex flex-col overflow-scroll" },
            [_c("router-view")],
            1
          )
        ],
      ...
      _c("div", {
        ...
        class: _vm.sidemenuIsOpen ? "" : "hidden",
        on: { click: _vm.closeMenu }
      })
    ],
    1
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "flex-1 p-4 lg:p-8 overflow-scroll" }, [
      _vm.mailLoadStatus == 2
        ? _c(
            "div",
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex justify-center items-center h-full" }, [
    _c("div", { staticClass: "text-gray-300" }, [
      ...
      _vm._v(" "),
      _c("span", { staticClass: "block" }, [_vm._v("No mail selected")])
    ])
  ])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getters: {
    getSidemenuOpen: function getSidemenuOpen(state) {
      return state.sidemenuIsOpen;
    }
  },
  mutations: {
    setSidemenuOpen: function setSidemenuOpen(state, data) {
      state.sidemenuIsOpen = data;
    }
  },
  actions: {
    openSidemenu: function openSidemenu(_ref) {
      var commit = _ref.commit;
      commit('setSidemenuOpen', true);
    },
    closeSidemenu: function closeSidemenu(_ref2) {
      var commit = _ref2.commit;
